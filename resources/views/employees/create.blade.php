                        ...
                        <div class="card-body">
                            <form action="{{ route('employees.store') }}" method="POST" id='createForm'
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="my-3 md-form">
                                            <input type="password" name="nrc_number" class="form-control py-2 @error('nrc_number') is-invalid @enderror"
                                    ...
                                    <div class="col">
                                        <div class="my-1 md-form">
                                            ...
                                            <input type="text" name="date_of_join" id="date_of_join"
                                                class="form-control" placeholder="date_of_join" value="{{ old('date_of_join') }}">
                                ...
                                <div class="mt-2 md-from">
                                    <textarea name="address" cols="30" rows="3" class="form-control @error('address') is-invalid @enderror" placeholder="Address">{{ old('address') }}</textarea>
                                    @error('address')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button form="createForm" type="submit" class="btn btn-sm btn-primary">Create</button>
                                </div>
                            </div>
                        </form>
